...
const sections = [
  ...
  { title: "2. Definitions", content: "\"Business\" refers to any establishment that has registered to use the Perky platform. \"Customer\" refers to any individual who scans a Perky QR code or interacts with the platform as an end user. \"Perky Points (PP)\" refers to the loyalty points earned and redeemed through the Perky network. \"Reward Wheel\" refers to the gamified reward mechanism available to Customers upon check-in." },
  { title: "3. Eligibility", content: "The Service is available to businesses operating in New Zealand and Australia. Businesses must provide accurate registration information and maintain a valid subscription. Customers must be at least 16 years of age to participate in the loyalty programme." },
  ...
  { title: "5. Subscription & Pricing", content: "Perky Starter: $100/month plus a one-time $30 setup fee. Perky Premium: $150/month plus a one-time $30 setup fee. Subscriptions are billed monthly. We reserve the right to change pricing with 30 days written notice. You may cancel at any time; cancellation takes effect at the end of the current billing period. No refunds are provided for partial months." },
  { title: "6. Perky Points", content: "Points are earned by Customers when they check in at participating Businesses. Points are stored in a universal wallet and may be redeemed at any Business within the Perky network. Points have no cash value, are non-transferable, and cannot be exchanged for money. We reserve the right to adjust point balances in cases of fraud, error, or abuse." },
  ...
  { title: "8. Acceptable Use", content: "You agree not to: use the Service for any unlawful purpose; attempt to gain unauthorised access to any part of the Service; manipulate, exploit, or abuse the points or rewards system; upload harmful, offensive, or infringing content; or interfere with the operation or security of the Service." },
  ...
  { title: "12. Termination", content: "We may suspend or terminate your access at any time, with or without cause, upon reasonable notice. Upon termination, your right to use the Service ceases immediately. Accrued Perky Points held by Customers remain in their wallets and may be redeemed at other participating Businesses." },
    ...
    <div className="min-h-screen bg-oat">
      ...
      <main className="container py-12 md:py-20">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-sm text-espresso-light/50 mb-12" style={{ fontFamily: "var(--font-body)" }}>Last updated: April 2026</p>
